...
/**
 * A {@link Spell} implementation which fires an arrow that deals less damage
 * than one shot with a bow.
 *
 * @since 0.0.5
 */
public class WeakBow implements Spell {
     ...
     * @since 0.0.5
     */
    public WeakBow(final SpellManager spellManager) {
    ...
    public float rightClick(final Player caster, final Block block,
            final int modifier, final BlockFace face) {
        final Entity ent = caster.launchProjectile(Arrow.class);
