 ...
 * @since 0.1.0
 */
public class SecondprofessionAbandonCommand extends PlayerCommandHandler {
    /**
     * Constructor.
     *
     ...
     * @since 0.1.0
     */
    public SecondprofessionAbandonCommand(@Nonnull final RolecraftCore plugin) {
        super(plugin, "abandon");

        this.setPermission("rolecraft.profession.abandonsecondary");
    }
